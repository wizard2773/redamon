...
from models import ReconState, ReconStatus, ReconLogEvent, GvmState, GvmStatus, GvmLogEvent
...
class ContainerManager:
    """Manages Docker containers for recon and GVM scan processes"""

    def __init__(self, recon_image: str = "redamon-recon:latest", gvm_image: str = "redamon-vuln-scanner:latest"):
